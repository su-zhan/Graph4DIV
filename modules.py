...
class GraphConvolutionNetwork(nn.Module):
    def __init__(self, node_feature_dim, hidden_dim, output_dim, activation = "relu", batch_norm = True, normalization = False):
        ...
        self.normalization = normalization
        print('GCN normalization\t', normalization)
    ...
    def represent(self, adjacency, x):
